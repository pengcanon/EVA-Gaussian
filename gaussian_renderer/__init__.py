...
def render_f(data, idx, pts_xyz, pts_rgb, rotations, scales, opacity, bg_color, pts_features=None):
    """
    Render the scene. 
    ...
    rendered_image, feature_map, mask, depth_map, _  = rasterizer(
        means3D=pts_xyz,
    ...
    return rendered_image, feature_map
